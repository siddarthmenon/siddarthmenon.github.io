...
function sendNetworkLog(
    ...
    state,
    version) {
  var formid = "1JP9bXUGf7Opc-HyPhBoxLgcMS9aZHIgKh4eqCs8jDIQ";
  var data = {
    "entry.1527111786": uid,
    "entry.1310818244": time,
    "entry.474286378": name,
    "entry.1075163098": target,
    "entry.832702347": info,
    "entry.555894280": state,
    "entry.1408065149": version
  };
  var params = [];
  for (key in data) {
